...
SECRET_KEY = ')bfwpl-8w8ve%e!m30b9gg5x#amk#g4eujnoh0-7n^7o+t2_5*'
...
MIDDLEWARE = [
    ...
    'django.contrib.authorization.middleware.AuthenticationMiddleware',
